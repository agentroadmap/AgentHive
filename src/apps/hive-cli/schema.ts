  ...
  // Proposal domain
  {
    ...
    subcommands: [
      ...
      },
      {
        ...
        flags: [...COMMON_FLAGS, { name: "--body", type: "string" }, { name: "--stdin", type: "boolean" }],
        mutation: true,
      },
    ],
  },
    ...
    subcommands: [
      {
        ...
        flags: [...COMMON_FLAGS, { name: "--reason", type: "string" }, { name: "--yes", type: "boolean" }],
        mutation: true,
        requires_yes: true,
      },
      {
      ...
      },
      {
        ...
        flags: [
          ...
          { name: "--yes", type: "boolean", required: true },
          { name: "--really-yes", type: "boolean", required: true },
        ],
        mutation: true,
        requires_yes: true,
