...
export async function createMcpServer(
	...
	// P459: Only register file-based cubic tools when not using Postgres;
	// in Postgres mode, PG-backed cubic tools (with phase-role enforcement) are registered below.
	if (!usePostgres) {
