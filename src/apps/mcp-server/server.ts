...
export async function createMcpServer(
	...
	server.addTool({
		...
		description:
			"Register an agency (long-lived identity) in agent_registry. Call this first before registering as a provider.",
	...
	const agencyLifecycleHandlers = await import(
	...
	console.error(
		"[MCP] Registered 9 P466/P468/P475 spawn-briefing tools + 4 P917 agency-lifecycle tools (liaison protocol)",
	);
