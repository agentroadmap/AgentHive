...
const arrowClasses: Record<TooltipPlacement, string> = {
	...
	bottom:
		"bottom-full left-1/2 -translate-x-1/2 border-b-[var(--color-text)] border-l-transparent border-r-transparent border-t-transparent border-4",
	...
	right:
		"right-full top-1/2 -translate-y-1/2 border-r-[var(--color-text)] border-t-transparent border-b-transparent border-l-transparent border-4",
};
		...
		<span className="relative inline-flex">
			...
			{visible && !disabled && (
				...
				>
					{content}
					<span
						className={cn("absolute", arrowClasses[placement])}
						aria-hidden="true"
					/>
				</span>
			)}
