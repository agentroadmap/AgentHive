 ...
 *   offline    → dormant    : first check-in after offline (P765 AC-1, step 1)
 *   dormant    → active     : second check-in after offline (P765 AC-1, step 2)
 *   offline    → active     : operator resume command (P765 AC-2, short-circuit)
 *   any        → active     : operator_resume signal via resumeAgency() (P765 AC-2)
