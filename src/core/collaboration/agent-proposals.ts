...
export async function resolveCollaborationLeaseTtlMs(): Promise<number> {
	try { return await runtimeConfig.get(FlagKeys.COLLABORATION_LEASE_TTL_MS); }
	catch { return DEFAULT_LEASE_TTL_MS; }
}
