// Cross-branch proposal snapshot helpers.
//
// Extracted from Core (src/core/roadmap.ts) during the Phase 1 monolith
// decomposition. These are pure functions that build and query the
// "latest proposal map" used for cross-branch ID deduplication and
// proposal filtering.
