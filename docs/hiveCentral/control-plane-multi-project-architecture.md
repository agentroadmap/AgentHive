...
Draft architecture. This document consolidates and supersedes the split assumptions in the P298 design notes (the earlier P300 multi-project design is now obsolete; the active successor is P429/P483).
