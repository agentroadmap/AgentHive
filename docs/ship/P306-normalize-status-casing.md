...
|----|-----------|--------|----------|
| AC-1 | All proposal.status values normalized to UPPERCASE in live DB | PASS | DRAFT(36), REVIEW(15), DEVELOP(29), MERGE(2), COMPLETE(68), DEPLOYED(34) |
...
| AC-6 | Exactly 6 distinct statuses | PASS | `SELECT COUNT(DISTINCT status) = 6` — DRAFT, REVIEW, DEVELOP, MERGE, COMPLETE, DEPLOYED |
